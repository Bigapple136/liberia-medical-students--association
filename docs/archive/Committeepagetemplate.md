// ============================================
// FILE: src/pages/committees/CommitteePageTemplate.jsx
// Data-driven public template — replaces all 12 individual stub files.
// Route: /committees/:slug  →  fetches committee by slug from API
// ============================================
...
import {
  ...
  Calendar, Download, Mail, Bell, Award, Share2,
  Clock, MapPin, ExternalLink, ChevronRight, Loader,
  Facebook, Twitter, Linkedin, Check, AlertCircle, Info
} from 'lucide-react';
...
export default function CommitteePageDynamic() {
...
export function CommitteesOverviewPage() {
  ...
  const filtered = Object.entries(ALL_COMMITTEES_DATA)
    .filter(([slug, c]) => c.name.toLowerCase().includes(search.toLowerCase()));
